...
import top.ldj.boot.mp.service.impl.UserAccountServiceImpl;
...
class UserAccountServiceTest {
    ...
    void testMapperUpdateById(){
        ...
        int result=userAccountMapper.updateById(testUser);assertEquals(1,result);
    ...
    void testMapperUpdateByIdFailed(){
        ...
        int result=userAccountMapper.updateById(testUser);assertEquals(0,result);
        verify(userAccountMapper,times(1)).updateById(testUser);
    }
    @Test
